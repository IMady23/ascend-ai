...
export function ProgressHero() {
  ...
  const level = 12; // Mock level
  const totalXp = 14500; // Mock XP
  const overallProgress = 34; // Mock %
  const streak = 18; // Mock streak
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex flex-col items-start bg-zinc-950/50 border border-zinc-800/50 rounded-xl p-4 backdrop-blur-sm min-w-[110px]">
          ...
          <div className="flex flex-col items-start bg-zinc-950/50 border border-zinc-800/50 rounded-xl p-4 backdrop-blur-sm min-w-[110px]">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-2xl font-black text-white font-mono">{(totalXp / 1000).toFixed(1)}k</span>
            </div>
          </div>

          <div className="hidden sm:flex flex-col items-start bg-zinc-950/50 border border-zinc-800/50 rounded-xl p-4 backdrop-blur-sm min-w-[110px]">
            <div className="flex items-center gap-2 text-zinc-400 mb-1">
