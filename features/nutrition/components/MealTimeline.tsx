  ...
  return (
    <section className="bg-surface border border-border-subtle rounded-2xl overflow-hidden">
      <div className="p-6 md:p-8 border-b border-border-subtle">
        <h2 className="text-xl font-bold text-primary">Daily Log</h2>
      </div>
...
function MealCard({ meal }: { meal: any }) {
  ...
  return (
    <div className="p-6 hover:bg-surface-elevated/20 transition-colors flex flex-col sm:flex-row justify-between gap-4">
      <div>
        <h3 className="font-bold text-primary text-lg capitalize mb-1">{meal.mealType}</h3>
      ...
      <div className="flex gap-4 sm:gap-6 text-sm">
        <div className="flex flex-col items-center">
          <span className="text-secondary text-xs font-bold uppercase mb-1">Cals</span>
          <span className="text-orange-400 font-bold font-mono">{meal.calories}</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-secondary text-xs font-bold uppercase mb-1">Pro</span>
          <span className="text-red-400 font-bold font-mono">{meal.protein}g</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-secondary text-xs font-bold uppercase mb-1">Carb</span>
          <span className="text-amber-400 font-bold font-mono">{meal.carbs}g</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-secondary text-xs font-bold uppercase mb-1">Fat</span>
