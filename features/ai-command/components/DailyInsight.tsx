...
export function DailyInsight() {
  return (
    <div className="bg-surface border border-border-subtle rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5 transition-transform hover:-translate-y-1 duration-300">
      ...
      <div>
        <h3 className="text-primary font-bold text-lg mb-1">Daily Insight</h3>
