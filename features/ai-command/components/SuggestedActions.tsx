        ...
        {actions.map((action, i) => {
          ...
          return (
            <button 
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col items-start gap-4 transition-transform hover:-translate-y-1 hover:border-violet-500/50 hover:bg-zinc-800/80 duration-300 group text-left disabled:opacity-50 disabled:hover:translate-y-0"
            >
