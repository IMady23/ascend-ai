...
export function CommandCenterHero() {
  ...
  return (
    <motion.section 
      ...
      className="bg-zinc-950/80 border border-purple-500/30 rounded-2xl p-6 md:p-10 relative overflow-hidden backdrop-blur-xl shadow-[0_0_50px_rgba(168,85,247,0.05)]"
    >
        ...
        <div>
          ...
          <div className="flex gap-4 mt-8">
             <div className="flex flex-col">
               <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Current Chapter</span>
               <span className="text-lg font-bold text-zinc-200">{currentChapter?.title || "Initiation"}</span>
             </div>
             <div className="w-px h-10 bg-zinc-800" />
             <div className="flex flex-col">
               <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Phase</span>
               <span className="text-lg font-bold text-zinc-200">Execution</span>
             </div>
             <div className="w-px h-10 bg-zinc-800 hidden sm:block" />
             <div className="flex flex-col hidden sm:flex">
               <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-1">Streak</span>
               <span className="text-lg font-bold text-zinc-200">{streak} Days</span>
             </div>
          </div>
        </div>

        {/* System Status Panel */}
        <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-5 backdrop-blur-md min-w-[240px]">
          <div className="flex items-center gap-2 mb-4">
             <div className="relative flex h-3 w-3">
               <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
               <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-500"></span>
             </div>
             <span className="text-xs font-bold text-zinc-300 uppercase tracking-widest">System Status</span>
          </div>
          ...
          <div className="space-y-1.5 mt-4 text-[10px] font-mono text-zinc-500 uppercase tracking-wider">
