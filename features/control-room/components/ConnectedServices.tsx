    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {services.map((service) => (
          <div key={service.id} className="p-3 bg-zinc-950/50 rounded-lg border border-zinc-800/50 flex flex-col justify-between min-h-[100px]">
             ...
             <div>
               <h3 className="text-sm font-semibold text-zinc-200 mb-1">{service.name}</h3>
