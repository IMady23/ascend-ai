  ...
  return (
    <GlassCard className={cn(
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-6 items-start md:items-center">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--color-accent-gold)] to-amber-600 flex items-center justify-center text-black shrink-0 shadow-[0_0_20px_rgba(var(--color-accent-gold-rgb),0.3)]">
          {icon}
        </div>
        ...
        <div className="flex-1">
          ...
          <BodyText size="sm" className="text-[var(--color-text-secondary)]">{description}</BodyText>
        </div>
        
        <div className="text-left md:text-right shrink-0">
          <div className="font-mono text-3xl font-bold text-[var(--color-text-primary)] tracking-tight">{metric}</div>
        </div>
      </div>
    </GlassCard>
  );
