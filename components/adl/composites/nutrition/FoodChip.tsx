...
export function FoodChip({
  ...
  return (
    <div className={cn(
      "flex items-start gap-3 p-3 rounded-[var(--radius-lg)] bg-surface border border-border-subtle hover:border-[var(--color-text-muted)] transition-colors",
      className
    )}>
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <Caption className="text-secondary leading-snug">
          {reason}
        </Caption>
      </div>
    </div>
