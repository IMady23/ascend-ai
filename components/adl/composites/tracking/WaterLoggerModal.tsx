  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4 bg-base/60 backdrop-blur-sm">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-sm h-[90vh] md:h-auto md:max-h-[80vh] flex flex-col min-h-0 mt-auto md:mt-0"
        ref={scrollRef}
      >
        <GlassCard intensity="high" className="flex flex-col h-full min-h-0 overflow-y-auto shadow-2xl p-6 rounded-t-[32px] md:rounded-[var(--radius-2xl)] rounded-b-none md:rounded-b-[var(--radius-2xl)]">
